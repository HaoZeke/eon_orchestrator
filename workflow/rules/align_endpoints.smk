...
rule align_endpoints_pre:
    ...
    output:
        reactant=config['paths']['endpoints'] + '/{system}/reactant_pre_aligned.con',
        product=config['paths']['endpoints'] + '/{system}/product_pre_aligned.con',
    params:
...
rule align_endpoints_post:
    ...
    """
    input:
        reactant=config['paths']['endpoints'] + '/{system}/reactant_minimized.con',
        product=config['paths']['endpoints'] + '/{system}/product_minimized.con',
    output:
